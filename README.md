...
誰調用(call function)，this就指向誰，如果沒有就會是global、window、undefiend
1. 常規函數中的有this
...
<p>TypeError，changeColor是一個靜態方法，只能在初始建構式時使用，被能被實例所使用</p>
</details>
...
### Front end Q45: 以下是pure function?
```javascript
function sum(a, b) {
  return a + b;
}
...
### Front end Q76: JSON.stringify and JSON.parse
